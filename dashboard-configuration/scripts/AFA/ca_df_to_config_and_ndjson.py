...
config = pd.read_csv('ca-afa-2021.csv',sep=",") # Configuration à mettre à jour
...
config['Code_indicateur'] = 'CA_'+config['Titre_onglet']+'_'+config['Titre_panneau']+'_'+data.iloc[:,0]
config.to_csv('ca-afa-2021.csv',sep=',',index=False,quoting=csv.QUOTE_NONNUMERIC)
